...
export const zh = {
  ...
  retry: '重试',
  search: '搜索 Skill',
  empty: '未发现 Skill。请确认当前 Agent Preset 已加载 dsh-skill-preferences/preset。',
...
export const en = {
  ...
  empty: 'No skills were found. Confirm that the current Agent Preset loads dsh-skill-preferences/preset.',
